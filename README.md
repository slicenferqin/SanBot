...
- **元认知监控**: 对自身推理过程的反思与纠正
- **流式输出**: 实时显示 AI 响应，减少等待焦虑
- **工具状态显示**: 清晰展示工具调用过程和执行时间
...
- [TUI 重构计划](docs/TUI-Refactor-Plan.md)
- [TUI 阶段一实现总结](docs/TUI-Implementation-Phase1.md)
- [TUI 快速参考](docs/TUI-Quick-Reference.md)
